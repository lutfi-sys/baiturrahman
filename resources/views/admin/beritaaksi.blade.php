    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            <ul>
                ...
                <li style=" background-color: #f4f4f4;  color: #43917a; border-radius: 5px;"><a href="/berita"><i class="fa fa-newspaper" ></i> Berita</a></li>
    ...
    <div class="content">
        ...
        <div class="content-form">
            <div class="">
                  ...
                  <div class="" role="tab" id="headingThree2">
                    <h6 class="">
                      <a class="collapsed transition" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree2" aria-expanded="true" aria-controls="collapseThree2">
                        Tambah Berita <span><i class="fa fa-plus-square tx-30"  aria-hidden="true"></i></span>
                      </a>
                    </h6>
                  </div>
             ...
             <form class="" method="POST" action="{{ route('berita.update', $berita->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                        @if($berita->gambar)
                            <img src="data:image/jpeg;base64,{{ $berita->gambar }}" alt="{{ $berita->judul }}" style="width: 100px; height: auto; margin-bottom: 10px;">
                        @endif
                        <input type="file" name="gambar" id="gambar" class="form-control " placeholder="Foto" aria-describedby="helpId" required>
                        </div>
                    </div>
                    <div class="mb-3 ">
                        <label for="keterangan" class="form-label"><b>Keterangan :</b></label>
                        <textarea class="form-control " name="keterangan" id="keterangan" rows="3" required>{{ $berita->keterangan }}</textarea>
                    </div>
