    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            <ul>
                ...
                <li  style=" background-color: #f4f4f4;  color: #43917a; border-radius: 5px;"><a href="/profil"><i class="fa fa-address-card"></i> Profil</a></li>
        ...
        <div class="content-form">
            <div class="">
                  ...
                  <div class="" role="tab" id="headingThree2">
                    <h6 class="">
                      <a class="collapsed transition" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree2" aria-expanded="true" aria-controls="collapseThree2">
                        Tambahkan Profil <span><i class="fa fa-plus-square tx-30"  aria-hidden="true"></i></span>
                      </a>
                    </h6>
                  </div>
             ...
             <form class="" method="POST" action="" enctype="multipart/form-data">
                  @csrf
                    <div class="mb-3 row">
                        <label for="visi" class="col-sm-2 col-form-label"><b>Visi</b></label>
                        <div class="col-sm-10">
                            <textarea class="form-control " name="visi" id="visi" rows="3" required></textarea>
                        </div>
                      </div>
                    <div class="mb-3 row">
                        <label for="misi" class="col-sm-2 col-form-label"><b>Misi</b></label>
                        <div class="col-sm-10">
                            <textarea class="form-control " name="misi" id="misi" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="sejarah" class="col-sm-2 col-form-label"><b>Sejarah</b></label>
                        <div class="col-sm-10">
                            <textarea class="form-control " name="sejarah" id="sejarah" rows="3" required></textarea>
                        </div>
                      </div>
                    <div class="mb-3 row">
                        <label for="mars" class="col-sm-2 col-form-label" ><b>Mars Yayasan</b></label>
                        <div class="col-sm-10">
                            <textarea class="form-control " name="mars" id="mars" rows="3" required></textarea>
                        </div>
                    </div>

                    <div class="mb-3 row">
                        <label for="vidio" class="col-sm-2 col-form-label"><b>Vidio </b></label>
                        <div class="col-sm-10">
                          <input type="url" class="form-control" id="vidio" name="vidio" required>
                        </div>
                    </div>
