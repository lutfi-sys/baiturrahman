    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            <ul>
                ...
                <li style=" background-color: #f4f4f4;  color: #43917a; border-radius: 5px;"><a href="/sosmed"><i class="fas fa-play"></i> Sosial Media</a></li>
        ...
        <div class="content-form">
            <div class="">
                  ...
                  <div class="" role="tab" id="headingThree2">
                    <h6 class="">
                      <a class="collapsed transition" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree2" aria-expanded="true" aria-controls="collapseThree2">
                        LINK SOSMED <span><i class="fa fa-plus-square tx-30"  aria-hidden="true"></i></span>
                      </a>
                    </h6>
                  </div>
             ...
             <form class="" method="POST" action="" enctype="multipart/form-data">
                  @csrf
                    <div class="mb-3 row">
                        <label for="yt" class="col-sm-2 col-form-label"><img src="yt_nb.png" width="50px"></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="yt" name="yt" required>
                        </div>
                      </div>
                    <div class="mb-3 row">
                        <label for="ig" class="col-sm-2 col-form-label" ><img src="ig_nb.png" width="50px"></label>
                        <div class="col-sm-10">
                        <input type="text" name="ig" id="ig" class="form-control "  required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="fb" class="col-sm-2 col-form-label" ><img src="fb_nb.png" width="50px"></label>
                        <div class="col-sm-10">
                        <input type="text" name="fb" id="fb" class="form-control "  required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="tt" class="col-sm-2 col-form-label" ><img src="tt.png" width="50px"></label>
                        <div class="col-sm-10">
                        <input type="text" name="tt" id="tt" class="form-control "  required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="wa" class="col-sm-2 col-form-label" ><img src="wa_nb.png" width="50px"></label>
                        <div class="col-sm-10">
