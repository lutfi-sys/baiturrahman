...
<body>
    ...
    <div class="content">
        ...
        <div class="content-form" style="padding-left:5%">
            <div class="" >
             ...
             <form class="" method="POST" action="{{ route('pegawai.store') }}" enctype="multipart/form-data">
                  @csrf
                    <div class="mb-3 row">
                        <label for="jname" class="col-sm-2 col-form-label"><b>Nama</b></label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        ...
                        <select name="role" id="role" class="form-control ">
                            <option value="Kepalan Yayasan">Kepala Yayasan</option>
            ...
            <form action="" method="post" name="periode" target="">
              ...
              <table id="example" class="table mt-2" style="width:100%">
                ...
                <tbody>
                  ...
                  <tr>
                    <td> {{ $item->name }}</td>
                    <td> <img src="data:image/jpeg;base64,{{$item->foto}}" alt="{{ $item->name }}" style="width: 100px; height: auto;"></td>
                    <td> {{ $item->keterangan }}</td>
                    <td><a href="{{ route('pegawai.edit', $item->id) }}"><button class="btn btn-success" id="showFormBtn">Update</button></a>
                      <a href="{{ route('pegawai.destroy', $item->id) }}"><button class="btn btn-warning" >Delete</button></td></a>
                  </tr>
                  @endforeach
