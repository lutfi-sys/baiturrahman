    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            <ul>
              ...
              <li style=" background-color: #f4f4f4;  color: #43917a; border-radius: 5px;"><a href="/surat"><i class="fa fa-envelope"></i> Persuratan</a></li>
        ...
        <div class="content-form">
            <div class="">
                  ...
                  <div class="" role="tab" id="headingThree2">
                    <h6 class="">
                      <a class="collapsed transition" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree2" aria-expanded="true" aria-controls="collapseThree2">
                        Buat Surat <span><i class="fa fa-plus-square tx-30"  aria-hidden="true"></i></span>
                      </a>
                    </h6>
                  </div>
             ...
             <form class="" method="POST" action="" enctype="multipart/form-data">
                  @csrf
                    <div class="mb-3 row">
                        <label for="nomor" class="col-sm-2 col-form-label"><b>Nomor</b></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="nomor" name="nomor" required>
                        </div>
                      </div>
                    <div class="mb-3 row">
                        <label for="hal" class="col-sm-2 col-form-label"><b>Hal</b></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="hal" name="hal" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="lamp" class="col-sm-2 col-form-label"><b>Lamp</b></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="lamp" name="lamp" required>
                        </div>
                      </div>
                    <div class="mb-3 row">
                        <label for="kepada" class="col-sm-2 col-form-label" ><b>Kepada</b></label>
                        <div class="col-sm-10">
                        <input type="text" name="kepada" id="kepada" class="form-control " placeholder="" aria-describedby="helpId" required>
                        </div>
                    </div>

                    <div class="mb-3 row">
                        <label for="tgl_acara" class="col-sm-2 col-form-label"><b>Tanggal Acara</b></label>
                        <div class="col-sm-10">
                          <input type="date" class="form-control" id="tgl_acara" name="tgl_acara" required>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="waktu" class="col-sm-2 col-form-label"><b>Waktu</b></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="waktu" name="waktu" required>
                        </div>
                      </div>
                      <div class="mb-3 row">
                        <label for="tempat" class="col-sm-2 col-form-label"><b>Tempat</b></label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        <label for="isi" class="col-sm-2 col-form-label"><b>Isi Surat</b></label>
                        <div class="col-sm-10">
                            <textarea class="form-control " name="isi" id="isi" rows="3" required></textarea>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="tgl_surat" class="col-sm-2 col-form-label"><b>Tanggal Surat</b></label>
                        <div class="col-sm-10">
    ...
    <div class="content-table">
        <div class="container bg-white p-3 mt-3">
            ...
            <form action="" method="post" name="periode" target="">
              ...
              <div class="row mb-2">
                <div class="col-lg-4">
                  <input name="" type="date" value="" id="" class="form-control " size="10">
                </div>
                <div class="col-lg-4">
                  <input name="" type="date" value="" id="" class="form-control" size="10">
                </div>
              ...
              <table id="example" class="table mt-2" style="width:100%">
                ...
                {{-- <tbody>
                  ...
                  <tr>
                    <td> {{ $item->judul }}</td>
                    <td> <img src="data:image/jpeg;base64,{{$item->gambar}}" alt="{{ $item->judul }}" style="width: 100px; height: auto;"></td>
                    <td> {{ $item->keterangan }}</td>
                    <td><a href="{{ route('berita.edit', $item->id) }}"><button class="btn btn-success" id="showFormBtn">Update</button></a>
                      <a href="{{ route('berita.destroy', $item->id) }}"><button class="btn btn-warning" >Delete</button></td></a>
                  </tr>
                  @endforeach
